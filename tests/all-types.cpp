...
struct AllTypes
{
    ...
    SQLT_TABLE(AllTypes,                                                // Table name = "AllTypes"
        ...
        SQLT_COLUMN_FLAGS_DEFAULT(id2, 123, SQLT::Flags::PRIMARY_KEY),  // id2 INTEGER PRIMARY KEY NOT NULL DEFAULT 2
        SQLT_COLUMN_DEFAULT(num2, 1.23),                                // num2 REAL NOT NULL DEFAULT 2.22
        SQLT_COLUMN_DEFAULT(name2, "defaultz"),                         // name2 TEXT NOT NULL DEFAULT "second"
